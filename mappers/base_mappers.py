...
class CashbookMapper:
    ...
    def to_domain(dto: dict) -> CashbookEntry:
        ...
        return CashbookEntry(
            ...
            rep_120_days=float(dto.get("rep_120_days", 0)),
            ...
            disb_60d=float(dto.get("disb_60d", 0)),
            disb_120d=float(dto.get("disb_120d", 0)),
            disb_12w=float(dto.get("disb_12w", 0)),
            disb_24w=float(dto.get("disb_24w", 0)),
            disb_mth=float(dto.get("disb_mth", 0)),
            ...
            funds_received_other_area=float(dto.get("funds_received_other_area", 0)),
            ...
            daily_20_pct=float(dto.get("daily_20_pct", 0)),
            weekly_11_pct=float(dto.get("weekly_11_pct", 0)),
            weekly_20_pct=float(dto.get("weekly_20_pct", 0)),
    ...
    def to_database(entity: CashbookEntry) -> dict:
        d = {
            ...
            "rep_120_days": entity.rep_120_days,
            "rep_12_weeks": entity.rep_12_weeks,
            "rep_24_weeks": entity.rep_24_weeks,
            "rep_monthly": entity.rep_monthly,
            "disb_60d": entity.disb_60d,
            "disb_120d": entity.disb_120d,
            "disb_12w": entity.disb_12w,
            "disb_24w": entity.disb_24w,
            "disb_mth": entity.disb_mth,
            ...
            "funds_received_other_area": entity.funds_received_other_area,
            ...
            "daily_20_pct": entity.daily_20_pct,
            "weekly_11_pct": entity.weekly_11_pct,
            "weekly_20_pct": entity.weekly_20_pct,
