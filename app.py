...
if page == "Dashboard":
    ...
    with SupabaseUnitOfWork() as uow_p:
        ...
        r4.metric("🚨 Overdue Clients", f"₦{p_sum.get('overdue', {}).get('amount', 0.0):,.0f}", f"{p_sum.get('overdue', {}).get('count', 0)} Clients", delta_color="inverse")
        r5.metric("Portfolio PAR", p_sum.get('par', '0.00%'), f"{p_sum.get('overdue', {}).get('count', 0)} Overdue", delta_color="inverse")
